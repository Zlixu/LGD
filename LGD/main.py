...
def testsne(base_loader, model, params):
...
if __name__ == '__main__':
    ...
    if params.method in ['baseline', 'baseline++']:
        ...
        val_datamgr = SetDataManager(image_size, aug_type=params.aug_type, n_query=200, n_episode=params.n_episode, **few_shot_params)
    ...
    if not params.test:
        ...
        #testsne(base_loader,model,params)
